...
const rankColors = [
  "from-brass to-brass-bright",         // Gold for #1
  "from-muted-foreground/60 to-muted-foreground/40", // Silver for #2
  "from-brass/80 to-brass/60",          // Bronze for #3
];
      ...
      <CardContent className="p-4">
        <div className="flex items-start gap-4">
          ...
          <div className={`flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center font-bold text-lg ${
            candidate.rank <= 3
              ? `bg-gradient-to-br ${rankColors[candidate.rank - 1]} text-[var(--btn-fg)]`
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center justify-between gap-2">
              <div className="flex items-center gap-2">
                ...
                {candidate.rank === 1 && (
                  <Badge className="bg-brass text-[var(--btn-fg)] text-xs">
                    Top Pick
                  </Badge>
                )}
              </div>
