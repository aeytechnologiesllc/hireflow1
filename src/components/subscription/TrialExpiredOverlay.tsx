...
import { AlertTriangle, Crown, LogOut, Loader2, Check, ArrowUpCircle, RefreshCw } from "lucide-react";
...
export default function TrialExpiredOverlay() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start md:items-center justify-center overflow-y-auto p-4 py-8 md:py-4 bg-background">
      ...
      <div className="absolute top-0 right-0 w-96 h-96 bg-primary rounded-full blur-[150px] pointer-events-none" style={{ opacity: 0.15 }} />
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-[var(--brass)] rounded-full blur-[150px] pointer-events-none" style={{ opacity: 0.12 }} />
      ...
      >
        <div className="p-6 md:p-8 rounded-2xl border border-border bg-card/50 backdrop-blur-sm text-center">
          <div className="flex justify-center mb-6">
            <motion.div
              className="p-4 rounded-full bg-destructive/15 border border-destructive/30"
          ...
          {/* Billing Toggle */}
          <div className="flex items-center justify-center gap-3 p-1 rounded-full bg-muted/50 border border-border w-fit mx-auto mb-8">
            <button
              ...
              <motion.div
                ...
                className={`relative p-6 rounded-xl border transition-all ${
                  plan.popular
                    ...
                    : "bg-card/30 border-border hover:border-muted-foreground/30"
                }`}
              >
                {plan.popular && (
                ...
                <div className="space-y-4">
                  ...
                  >
                    {loading === plan.id ? (
                      ...
                      <>
                        {plan.popular && <ArrowUpCircle className="h-4 w-4 mr-2" />}
          ...
          <div className="flex items-center justify-center gap-4">
            <Button
              variant="outline"
              className="border-primary/50 text-primary hover:bg-primary/10 bg-card"
