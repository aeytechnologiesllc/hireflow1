...
import { Lock, Crown, ArrowUpCircle, Check, Loader2 } from "lucide-react";
  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="p-6 rounded-xl border-2 border-dashed border-border bg-card/20 cursor-pointer hover:border-[var(--brass-line)] transition-all"
        onClick={() => setShowDialog(true)}
      >
        <div className="flex flex-col items-center text-center gap-4">
          <div className="p-3 rounded-full bg-[var(--hf-gold-soft)] border border-[var(--brass-line)]">
          ...
          <Button size="sm" variant="outline" className="gap-2 bg-transparent border-[var(--brass-line)] text-[var(--brass)] hover:bg-[var(--hf-gold-soft)]">
