  ...
  const modal = (
    ...
    >
      ...
      <motion.div
        ...
        className="relative z-10 my-auto w-full max-w-4xl overflow-hidden rounded-[28px] border border-primary/20 bg-card shadow-[0_32px_120px_-32px_hsl(var(--primary)/0.45)]"
      >
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top,hsl(var(--primary)/0.18),transparent_48%),radial-gradient(circle_at_bottom_right,hsl(var(--primary)/0.12),transparent_38%)]" />

        <button
          type="button"
          onClick={onClose}
          className="absolute right-4 top-4 z-20 flex h-11 w-11 items-center justify-center rounded-full border border-border bg-muted/50 text-muted-foreground transition hover:border-border hover:bg-muted hover:text-foreground"
          aria-label="Close"
        >
          <X className="h-4 w-4" />
        </button>
        ...
        <div className="relative z-10 grid gap-0 lg:grid-cols-[1.05fr_0.95fr]">
          <div className="border-b border-border px-5 pb-6 pt-8 sm:px-8 lg:border-b-0 lg:border-r">
            <div className="mx-auto flex max-w-xl flex-col items-center text-center lg:items-start lg:text-left">
              <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/10 px-3 py-1 text-xs font-medium uppercase tracking-[0.18em] text-primary">
              ...
              <div className="mt-6 flex w-full flex-col gap-3 sm:flex-row">
                <Button
                  ...
                  className="h-12 flex-1 bg-primary text-primary-foreground shadow-[0_18px_40px_-20px_hsl(var(--primary)/0.9)] transition hover:bg-primary/90"
                >
                  Start posting jobs
                ...
                <Button
                  ...
                  className="h-12 flex-1 border-border bg-muted/20 text-foreground hover:bg-muted/40"
                >
          ...
          <div className="px-5 py-8 sm:px-8">
            <div className="mx-auto flex h-full max-w-xl flex-col">
              <div className="inline-flex w-fit items-center gap-2 rounded-full border border-border bg-muted/30 px-3 py-1 text-xs font-medium text-muted-foreground">
              ...
              >
                {content.features.map((feature) => (
                  <motion.li
                    ...
                    className="flex items-start gap-3 rounded-2xl border border-border bg-muted/30 px-4 py-3.5"
                  >
              ...
              <div className="mt-5 rounded-2xl border border-primary/15 bg-primary/5 px-4 py-4">
