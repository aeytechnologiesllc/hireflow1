...
export default function AppHeader({ onMenuClick, isMobile }: AppHeaderProps) {
  ...
  return (
    <header className="h-14 md:h-16 bg-card md:bg-card/80 md:backdrop-blur-sm border-b border-border shadow-sm flex items-center justify-between px-4 md:px-6 shrink-0 overflow-hidden">
