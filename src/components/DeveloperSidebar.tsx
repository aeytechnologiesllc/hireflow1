          ...
          {isOpen && (
            ...
            >
              <div className="w-10 h-10 rounded-xl bg-destructive flex items-center justify-center shadow-lg shadow-destructive/20">
                <Terminal className="h-5 w-5 text-destructive-foreground" />
              </div>
              <div>
      ...
      <nav className="flex-1 relative z-10 p-3 space-y-1 overflow-y-auto">
        {navItems.map((item) => (
          <NavLink
            ...
            activeClassName="bg-destructive/10 text-foreground border border-destructive/20 shadow-sm"
          >
        ...
        <AnimatePresence mode="wait">
          {isOpen && (
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="px-3 py-2 rounded-xl bg-destructive/10 border border-destructive/20"
            >
