    ...
    <div className="border border-border rounded-lg overflow-hidden">
      <button
        ...
        className={cn(
          ...
          allPassed ? "bg-primary/5" : "bg-destructive/5"
        )}
      >
        <div className="flex items-center gap-3">
          <div className={cn(
            "w-8 h-8 rounded-lg flex items-center justify-center",
            allPassed ? "bg-primary/10" : "bg-destructive/10"
          )}>
            <Icon className={cn(
              "h-4 w-4",
        ...
        <div className="flex items-center gap-2">
          <Badge 
            ...
            className={cn(
              "text-xs",
              allPassed && "bg-primary hover:bg-primary/90"
            )}
          >
    ...
    <div className={cn("space-y-4", className)}>
      ...
      <div className="flex items-center justify-between">
        ...
        <Badge 
          ...
          className={cn(ready && "bg-primary hover:bg-primary/90")}
        >
...
export function DocumentValidationSummary({
  ...
  return (
    <div className={cn(
      ...
      ready ? "bg-primary/10" : "bg-[var(--warning)]/10",
      className
    )}>
      {ready ? (
      ...
      <span className={cn(
        "text-sm",
        ready ? "text-primary" : "text-[var(--warning)]"
      )}>
        {ready 
          ? "All checks passed"
