  ...
  return (
    <TooltipProvider>
      ...
      >
        ...
        <div className="hidden md:block absolute top-0 right-0 md:w-[600px] md:h-[600px] bg-[var(--brass)]/15 rounded-full md:blur-[150px] pointer-events-none" />
        <div className="hidden md:block absolute bottom-0 left-0 md:w-[500px] md:h-[500px] bg-primary/12 rounded-full md:blur-[150px] pointer-events-none" />
        ...
        <div className="flex-1 flex flex-col min-w-0 w-full max-w-full relative z-10">
          {/* Developer Header */}
          <header className="sticky top-0 z-30 h-14 md:h-16 border-b border-border/50 bg-background md:bg-background/80 md:backdrop-blur-xl">
