    ...
    <>
      ...
      >
        {currentMode === "auto" ? (
          ...
          <>
            <motion.div
              className="rounded-full bg-muted-foreground/70 p-1.5 text-background"
          ...
          <AnimatePresence mode="wait">
            {pendingMode === "auto" ? (
              ...
              >
                <DialogHeader className="pb-4 text-center">
                  <motion.div
                    className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-muted-foreground/70 text-background shadow-xl"
                ...
                <DialogFooter className="mt-6 flex gap-2 sm:justify-center">
                  ...
                  <Button
                    ...
                    className="bg-muted-foreground/80 text-background hover:brightness-110"
                  >
                    {updateJob.isPending ? (
                      <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                    ) : (
