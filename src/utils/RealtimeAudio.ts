...
export const getAudioQueue = (audioContext: AudioContext, onPlayingChange?: (playing: boolean) => void): AudioQueue => {
  if (!audioQueueInstance) {
    audioQueueInstance = new AudioQueue(audioContext, onPlayingChange);
  }
