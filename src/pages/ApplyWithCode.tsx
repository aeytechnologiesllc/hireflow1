...
export default function ApplyWithCode() {
  ...
  const handleSearch = useCallback(async (rawCode?: string) => {
    ...
    if (!normalizedCode) {
      setError("Enter a code first — that's how we'll find your role.");
      return;
    }
        ...
        {showcaseRole ? (
          ...
          >
            <div className="mb-6 text-center">
              ...
              <h1 className="font-display text-4xl font-medium text-foreground">Review the role</h1>
              <p className="mt-2 text-muted-foreground">No account needed — apply in about a minute.</p>
              <button
                type="button"
                onClick={handleSearchAnotherCode}
                className="mt-4 inline-flex min-h-11 items-center gap-2 py-2 text-sm font-medium text-primary transition-colors hover:text-primary/80"
              >
            ...
            <Card className="border-border bg-card shadow-xl">
              <CardContent className="p-6 sm:p-8 space-y-6">
                <div>
                  <h2 className="font-display text-2xl font-medium text-foreground">{showcaseRole.title}</h2>
                ...
                <Button size="lg" className="w-full sm:w-auto gap-2" onClick={() => navigate(`/candidate/apply/${showcaseRole.id}/form`)}>
                  Start application
          ...
          >
            <div className="mb-6 text-center">
              ...
              <p className="mt-2 text-muted-foreground">
                Make sure this is the right job — nothing is submitted until the very last step.
              </p>
              <button
                type="button"
                onClick={handleSearchAnotherCode}
              ...
              <CardContent className="p-6 sm:p-8 space-y-6">
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <h2 className="font-display text-2xl sm:text-3xl font-medium text-foreground">{previewJob.title}</h2>
                ...
                <div className="grid gap-3 sm:grid-cols-3">
                  <div className="rounded-xl border border-border bg-muted/30 p-4">
                    ...
                    <p className="mt-2 font-display ck-num text-2xl font-semibold text-foreground">{estimateCandidateTime(previewJob).range}</p>
                  </div>
                  <div className="rounded-xl border border-border bg-muted/30 p-4">
                    <div className="flex items-center gap-2 text-primary">
                    ...
                    <p className="mt-2 font-display ck-num text-2xl font-semibold text-foreground">{getPreviewStages(previewJob).length}</p>
                  </div>
                  <div className="rounded-xl border border-border bg-muted/30 p-4">
                    <div className="flex items-center gap-2 text-primary">
                    ...
                    <p className="mt-2 font-display ck-num text-2xl font-semibold text-foreground">{getRequiredMaterials(previewJob).length}</p>
                  </div>
                </div>
          ...
          >
            ...
            >
              ...
              <h1 className="font-display text-4xl font-medium text-foreground">Enter your job code</h1>
              <p className="mt-2 max-w-md text-muted-foreground">
                Enter the code from your recruiter and we'll pull up the role before you apply.
              </p>
            </motion.div>
              ...
              <CardContent className="p-8">
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    />
                    <p className="text-xs text-muted-foreground">Case doesn't matter — we'll match it either way.</p>
                  </div>
