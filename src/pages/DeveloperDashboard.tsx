  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card className="bg-gradient-to-br from-accent/40 to-accent/10 border-accent shadow-lg shadow-accent/5">
          <CardHeader className="pb-2">
        ...
        <Card className="bg-gradient-to-br from-secondary/60 to-secondary/20 border-secondary shadow-lg shadow-secondary/5">
          <CardHeader className="pb-2">
        ...
        <Tabs defaultValue="overview" className="space-y-4">
          ...
          <TabsContent value="overview" className="space-y-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              ...
              <Card className="bg-card/50 border-border/50">
                ...
                <CardContent>
                  <ChartContainer config={{ count: { label: "Signups", color: "hsl(var(--primary))" } }} className="h-64 w-full">
                  ...
                  {platformActivity?.topEmployers?.map((employer, index) => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-full bg-gradient-to-br from-primary to-accent-foreground flex items-center justify-center text-primary-foreground text-sm font-bold">
                          {index + 1}
                        </div>
                        <div>
              ...
              <CardContent>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div className="p-4 rounded-xl bg-primary/10 border border-primary/20 text-center">
                    <p className="text-2xl font-bold text-primary">{subscriptionStats?.active || 0}</p>
                    <p className="text-sm text-muted-foreground">Active</p>
                  </div>
                  <div className="p-4 rounded-xl bg-[var(--brass)]/10 border border-[var(--brass)]/20 text-center">
                    <p className="text-2xl font-bold text-[var(--brass)]">{subscriptionStats?.expired || 0}</p>
          ...
          <TabsContent value="features" className="space-y-4">
            ...
            <Card className="bg-card/50 border-border/50">
              ...
              <CardContent>
                <ChartContainer config={{ 
                  count: { label: "Usage Count", color: "hsl(var(--primary))" }
                }} className="h-72 w-full">
                  <BarChart 
