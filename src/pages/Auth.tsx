...
export default function Auth() {
  ...
  return (
    <div className="dark min-h-[100dvh] bg-background text-foreground relative overflow-y-auto">
      ...
      {/* Gradient orbs */}
      <div className="absolute top-0 left-1/4 w-[300px] h-[300px] sm:w-[500px] sm:h-[500px] bg-primary/[0.06] rounded-full blur-[140px] pointer-events-none" />
      <div className="absolute bottom-0 right-1/4 w-[250px] h-[250px] sm:w-[400px] sm:h-[400px] bg-accent/[0.04] rounded-full blur-[140px] pointer-events-none" />
