...
const COLORS = ['hsl(var(--primary))', 'hsl(var(--primary))', 'hsl(var(--accent))', 'hsl(142, 76%, 36%)'];
...
export default function DeveloperUsers() {
  ...
  const getRoleBadgeColor = (role: string | null) => {
    switch (role) {
      case 'developer': return 'bg-secondary text-secondary-foreground border-secondary';
      case 'employer': return 'bg-primary/10 text-primary border-primary/20';
      case 'team_member': return 'bg-accent/40 text-accent-foreground border-accent';
  ...
  const getStatusBadgeColor = (status: string | null) => {
    switch (status) {
      ...
      case 'trialing': return 'bg-accent/40 text-accent-foreground border-accent';
  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card className="bg-gradient-to-br from-accent/40 to-accent/10 border-accent">
          <CardHeader className="pb-2">
        ...
        <Card className="bg-gradient-to-br from-secondary/60 to-secondary/20 border-secondary">
          <CardHeader className="pb-2">
            <CardDescription className="flex items-center gap-2 text-secondary-foreground">
      ...
      <motion.div variants={itemVariants} className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <Card className="bg-card/50 border-border/50">
          ...
          <CardContent>
            <ChartContainer config={{ count: { label: "Signups", color: "hsl(var(--primary))" } }} className="h-48 w-full">
                    ...
                    <tr key={user.id} className="border-b border-border/30 hover:bg-muted/20 transition-colors">
                      <td className="py-3 px-4">
                        <div className="flex items-center gap-3">
                          <div className="w-9 h-9 rounded-full bg-gradient-to-br from-primary to-accent-foreground flex items-center justify-center text-primary-foreground text-sm font-medium">
