...
export const countryCodes: CountryCode[] = [
  ...
  { code: "+379", country: "VA", name: "Vatican", flag: "🇻🇦" },
...
// Get a country by its code or country abbreviation
export const getCountryByCode = (code: string): CountryCode | undefined => {
  return countryCodes.find(c => c.code === code || c.country === code);
};

// Default country (United States)
export const defaultCountry = countryCodes.find(c => c.country === "US")!;
